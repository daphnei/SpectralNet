...
general_params = {
        ...
        'model_in': 'test_with_image_dif.model',           # where to read a pre-trained model from, or None to initialize from scratch
        # 'model_in': None,           # where to read a pre-trained model from, or None to initialize from scratch
        'model_out': 'test_with_image_dif.model'           # where to write the trained model to, or None to not write it out
        }
...
wordsim_params = {
    ...
    'emb_dim': 50,                     # the dimension of the word embeddings
}
